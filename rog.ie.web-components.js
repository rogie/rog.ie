...
class HorrorText extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = `<span class="horror"><b>H</b><b>o</b><b>r</b><b>r</b><b>o</b><b>r</b></span> <svg fill="none"
             class="svgfx"
            ...
            <defs class="svgfx">
                <filter id="roughen-0"
                    ...
                    <feTurbulence type="fractalNoise"
                                  baseFrequency="0.06815564460770578 0.010761417569637763"
                                  seed="0"
                                  numOctaves="3"
                    ...
                    <feMerge>
                        <feMergeNode in="displacedContrast"></feMergeNode>
                    </feMerge>
                </filter>
            </defs>
        </svg>`;
